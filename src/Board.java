...
public class Board {
    ...
    public void addEuropeTracks() {
        ...
        graph.addTrack(graph.cityIndexMap.get(City.BREST), graph.cityIndexMap.get(City.PARIS), 3, TrainColor.BLACK);
        graph.addTrack(graph.cityIndexMap.get(City.BREST), graph.cityIndexMap.get(City.PAMPLONA), 4, TrainColor.PINK);
        ...
        graph.addTrack(graph.cityIndexMap.get(City.PAMPLONA), graph.cityIndexMap.get(City.PARIS), 4, TrainColor.BLUE);
        graph.addTrack(graph.cityIndexMap.get(City.PAMPLONA), graph.cityIndexMap.get(City.PARIS), 4, TrainColor.GREEN);
        ...
        graph.addTrack(graph.cityIndexMap.get(City.BERLIN), graph.cityIndexMap.get(City.WARSAWA), 4, TrainColor.PINK);
        graph.addTrack(graph.cityIndexMap.get(City.BERLIN), graph.cityIndexMap.get(City.WARSAWA), 4, TrainColor.YELLOW);
        graph.addTrack(graph.cityIndexMap.get(City.BERLIN), graph.cityIndexMap.get(City.WIEN), 3, TrainColor.GREEN);
        graph.addTrack(graph.cityIndexMap.get(City.WIEN), graph.cityIndexMap.get(City.WARSAWA), 4, TrainColor.BLUE);
        graph.addTrack(graph.cityIndexMap.get(City.WIEN), graph.cityIndexMap.get(City.BUDAPEST), 1, TrainColor.RED);
        graph.addTrack(graph.cityIndexMap.get(City.WIEN), graph.cityIndexMap.get(City.BUDAPEST), 1, TrainColor.WHITE);
        graph.addTrack(graph.cityIndexMap.get(City.ZAGRAB), graph.cityIndexMap.get(City.WIEN), 2, TrainColor.WILD);
        graph.addTrack(graph.cityIndexMap.get(City.ZAGRAB), graph.cityIndexMap.get(City.BUDAPEST), 2, TrainColor.ORANGE);
        graph.addTrack(graph.cityIndexMap.get(City.ZAGRAB), graph.cityIndexMap.get(City.SARAJEVO), 3, TrainColor.RED);
        graph.addTrack(graph.cityIndexMap.get(City.DANZIG), graph.cityIndexMap.get(City.RIGA), 3, TrainColor.BLACK);
        graph.addTrack(graph.cityIndexMap.get(City.RIGA), graph.cityIndexMap.get(City.PETROGRAD), 4, TrainColor.WILD);
        graph.addTrack(graph.cityIndexMap.get(City.RIGA), graph.cityIndexMap.get(City.WILNO), 4, TrainColor.GREEN);
        ...
        graph.addTrack(graph.cityIndexMap.get(City.PETROGRAD), graph.cityIndexMap.get(City.MOSKVA), 4, TrainColor.WHITE);
        graph.addTrack(graph.cityIndexMap.get(City.SMOLENSK), graph.cityIndexMap.get(City.MOSKVA), 2, TrainColor.ORANGE);
        graph.addTrack(graph.cityIndexMap.get(City.KYIV), graph.cityIndexMap.get(City.SMOLENSK), 3, TrainColor.RED);
